...
public class MiniBParser extends Parser {
	...
	public static final int
		...
		RULE_term = 20, RULE_factor = 21, RULE_boolean = 22, RULE_valFunc = 23, 
		RULE_lenFunc = 24, RULE_isNanFunc = 25, RULE_copyFunct = 26, RULE_concatFunc = 27, 
		RULE_subStringFunc = 28, RULE_charAtFunct = 29, RULE_arrayLiteral = 30, 
		RULE_arrayAccess = 31, RULE_factorOperations = 32, RULE_expOperations = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"bloqueControl", "condition", "expression", "term", "factor", "boolean", 
			"valFunc", "lenFunc", "isNanFunc", "copyFunct", "concatFunc", "subStringFunc", 
			"charAtFunct", "arrayLiteral", "arrayAccess", "factorOperations", "expOperations"
		};
	}
	...
	public final ValFuncContext valFunc() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_valFunc);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(262);
	...
	public final CopyFunctContext copyFunct() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_copyFunct);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(277);
	...
	public final SubStringFuncContext subStringFunc() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_subStringFunc);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(293);
	...
	public final CharAtFunctContext charAtFunct() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_charAtFunct);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(302);

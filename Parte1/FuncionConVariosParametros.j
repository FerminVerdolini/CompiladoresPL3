...
.method public static main([Ljava/lang/String;)V
    ...
    ; Llamar a la función "sumarNumeros" con los dos parámetros
    invokestatic FuncionConVariosParametros/sumarNumeros(II)I
...
; Definición de la función "sumarNumeros"
.method public static sumarNumeros(II)I
    .limit stack 2
    .limit locals 2
